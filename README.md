...
sqnc@2.0.5 minified file: [sqnc.min.js](https://github.com/forceuser/sqnc/releases/download/2.0.5/sqnc.min.js)

#### Or just load from CDN

```html
<script src="//cdn.rawgit.com/forceuser/sqnc/2.0.5/dist/sqnc.min.js">
</script>
```
